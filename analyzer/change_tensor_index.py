...
from analyzer import flip_index, mix_index1, mix_index2
from metrics import Metric
from solver import Energy


# TODO: Test


def change_tensor_index(input_tensor: Metric or Energy, index: str, metric_tensor: Metric = None):
